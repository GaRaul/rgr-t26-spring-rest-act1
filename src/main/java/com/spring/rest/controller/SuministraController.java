...
import com.spring.rest.service.SuministraServiceImpl;
...
public class SuministraController{
	...
	@GetMapping("/suministraciones/{id}")
	...
	@PutMapping("/suministraciones/{id}")
	...
	@DeleteMapping("/suministraciones/{id}")
